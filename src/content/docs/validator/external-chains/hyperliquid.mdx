...
4. Start the node
5. To Start the service as systemd service
6. Check latest block height
...
### To Start the service as systemd service

```bash
nano /etc/systemd/system/hyperliquid.service
```
